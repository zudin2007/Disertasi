...
**Measurement Approach:** Calculate coefficient of variation (CV) measuring price volatility. CV = standard deviation / mean. Thresholds: CV >1.0 (score 0), 0.5-1.0 (score 1), 0.1-0.5 (score 2), 0.01-0.1 (score 3), <0.01 (score 4-5).
...
- Peg Performance: Historically maintains ±1% range; typically ±0.5%
